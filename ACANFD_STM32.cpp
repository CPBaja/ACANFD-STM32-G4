...
//---------------------------------------------- Configure TxPin
  ...
  if (pinIndex < 8)
    LL_GPIO_SetAFPin_0_7 (gpio, txPinMask, inSettings.mTxPin.mPinAlternateMode) ;
  else
    LL_GPIO_SetAFPin_8_15 (gpio, txPinMask, inSettings.mTxPin.mPinAlternateMode) ;
...
//---------------------------------------------- Configure RxPin
  ...
  if (pinIndex < 8)
    LL_GPIO_SetAFPin_0_7 (gpio, rxPinMask, inSettings.mRxPin.mPinAlternateMode) ;
  else
    LL_GPIO_SetAFPin_8_15 (gpio, rxPinMask, inSettings.mRxPin.mPinAlternateMode) ;
